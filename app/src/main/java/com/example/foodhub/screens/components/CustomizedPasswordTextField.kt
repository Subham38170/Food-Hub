...
//Customized outlined textfield for password
@Composable
fun CustomizedPasswordTextField(
    value: String,
        ...
        OutlinedTextField(
            ...
            trailingIcon = {
                IconButton(
                    ...
                    Icon(
                        painter = painterResource(id = if (showPassword) R.drawable.visibility_off else R.drawable.visibility_on),
